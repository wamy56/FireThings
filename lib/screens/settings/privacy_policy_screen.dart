      ...
      body: ResponsiveListView(
        ...
        children: [
          ...
          Text(
            ...
            '• Dispatched job data — job details including site addresses, contact names, phone numbers, and job descriptions shared between company members for job assignment and tracking.\n'
            '• BS 5839 compliance data — if you use the BS 5839-1:2025 compliance features, we collect responsible person details (name, role, email, phone), digital signatures captured during inspection visits, professional qualifications and CPD records, inspection and audit records, and evidence photographs.',
            style: bodyStyle,
          ),
          const SizedBox(height: 24),
          ...
          Text(
            ...
            'If you join a company within FireThings, certain data is shared with other members of that company, including your display name, email, role, dispatched job data, shared sites and customers, BS 5839 compliance data (inspection records, variations, logbook entries), and engineer competency records (visible to team managers). Company data is protected by security rules that restrict access to authenticated members of that company only.\n\n'
          ...
          Text(
            ...
            '• Firebase Cloud Messaging (FCM) — push notifications for job assignment and status updates.\n'
